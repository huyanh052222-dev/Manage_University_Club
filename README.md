...
Mục Admin **Bổ sung kỳ trễ** là demo cho luồng hồi tố: danh sách hiển thị các kỳ Thứ Hai–Chủ nhật đã hoàn tất, trạng thái số quán đã chốt và cho phép chọn kỳ/quán/coin/lý do để tạo bản nháp. Bản nháp lưu cục bộ với khóa `admin-late-settlement-drafts-v1`; không gọi RPC, không thay đổi `teams.points`, sổ cái hay kết toán Supabase. Đây là lớp kiểm tra trước khi bật quyền ghi hồi tố thật.

...
Mục Admin **Bổ sung kỳ trễ** liệt kê các kỳ Thứ Hai–Chủ nhật đã hoàn tất, trạng thái số quán đã chốt và cho phép chọn kỳ/quán/coin/lý do. Có hai thao tác rõ ràng: **Cộng coin và chốt lại kỳ** tăng `teams.points` đúng một lần, ghi giao dịch `income` hồi tố và tính lại ảnh chụp kết toán; **Gán coin đã chọn vào kỳ** dùng những giao dịch `income` đã tồn tại (ví dụ hai dòng +103 và +93), không thay đổi số dư, chỉ gán `settlement_period_start` rồi tính lại doanh thu/lợi nhuận. Nhờ vậy một coin vào không bao giờ bị cộng hai lần, nhưng vẫn có thể được đối soát vào đúng kỳ.
...
Để bật quyền cộng/gán doanh thu cho kỳ trễ, chạy `scripts/supabase/late_settlement_adjustments.sql` đúng một lần. Migration thêm trường gán kỳ vào sổ cái và hai RPC Admin; khoản mới tăng số dư một lần, còn coin đã tồn tại chỉ đổi kỳ kết toán nên không thể bị cộng trùng.

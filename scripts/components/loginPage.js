        ...
        <div><strong>Cafe Horizon</strong><small>Admin Portal</small></div>
            ...
            <div class="auth-hero-copy">
                ...
                <div class="auth-feature-list">
                    <article><span>${icon("users")}</span><div><strong>8 đội</strong><small>Dữ liệu liên kết Supabase</small></div></article>
            ...
            <div class="login-card">
                ...
                <form class="login-form" data-login-form novalidate>
                    <div class="login-field">
                        <label for="admin-username">Email tài khoản Supabase</label>
                        <div>${icon("user")}<input id="admin-username" name="username" type="email" autocomplete="username" placeholder="admin@example.com" required /></div>
                    </div>
                ...
                <div class="demo-credentials">
                    ...
                    <div>
                        <strong>Đăng nhập bằng tài khoản Supabase</strong>
                        <p>Nhập email và mật khẩu đã được tạo trong Supabase Auth.</p>
                    </div>
                </div>
